...
import com.project.mydraw.repository.CategoryRepository;
import com.project.mydraw.service.CategoryService;
import com.project.mydraw.service.dto.CategoryDTO;
import com.project.mydraw.service.mapper.CategoryMapper;
import com.project.mydraw.service.dto.CategoryCriteria;
import com.project.mydraw.service.CategoryQueryService;
...
public class CategoryResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCategoriesByAlbumIsEqualToSomething() throws Exception {
        // Initialize the database
        categoryRepository.saveAndFlush(category);
        ...
        // Get all the categoryList where album equals to albumId
        defaultCategoryShouldBeFound("albumId.equals=" + albumId);

        // Get all the categoryList where album equals to albumId + 1
        defaultCategoryShouldNotBeFound("albumId.equals=" + (albumId + 1));
    }
